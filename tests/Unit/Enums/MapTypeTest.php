...
class MapTypeTest extends TestCase
{
    ...
    {
        $this->assertCount(5, MapType::cases());
        $this->assertEquals(['control', 'escort', 'hybrid', 'push', 'flashpoint'], MapType::values());
    }
    ...
    public function test_map_type_from_valid_string(): void
    {
        ...
        $this->assertEquals(MapType::Flashpoint, MapType::from('flashpoint'));
    }
